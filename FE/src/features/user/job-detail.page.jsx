...
import CompanyJobInfo from "@/features/user/job/company-job-info.section";
import JobDescription from "@/features/user/job/job-description.section";
import JobRequirements from "@/features/user/job/job-requirements.section";
import JobBenefits from "@/features/user/job/job-benefits.section";
import CompanyInfo from "@/features/user/job/company-info.section";
import {
  Tabs,
  TabsContent,
  TabsList,
...
export default function JobDetailPage({ jobId }) {
  ...
  const requirementsData = {
    technical: jobData.skills?.map((s) => s.name) || [],
